...
def upload():
    ...
    if file:
        try:
            ...
            # Process image using enhanced background remover
            processed_filename = f"processed_{filename}"
            processed_filepath = os.path.join(app.config['UPLOAD_FOLDER'], processed_filename)
            
            # Remove background with enhanced processing
            output_image = background_remover.remove_background(filepath, processed_filepath)
